...
In ShopXpert > Stock on Hold, select products that have pending stock.
...
Configure Features
Access ShopXpert's settings from your admin dashboard to set up the label customizations, pre-orders, stock on hold, wishlist, and dynamic search features.
...
<strong>Will ShopXpert slow down my website?</strong>
...
== Screenshots ==
Settings Page: Easily configure features like label changes, pre-orders, stock management, wishlist, and dynamic search.
