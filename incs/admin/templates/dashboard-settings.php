...
?>
<div id="smartshop_woo_template_tabs" class="shopxper-admin-main-tab-pane">
        ...
        <form class="smartshop-dashboard" id="smartshop-dashboard-settings-form" action="#" method="post" data-section="smartshop_woo_template_tabs" data-fields='<?php echo wp_json_encode( $element_keys ); ?>'>
            <div class="smartshop-admin-options">
                ...
                <div class="smartshop-admin-option smartshop-sticky-condition">
                    <button class="smartshop-admin-btn-save smartshop-admin-btn smartshop-admin-btn-primary hover-effect-1" style="margin-left:auto;" disabled="disabled"><?php echo esc_html__('DS Save Changes','shopxper');?></button>
                </div>
            </div>
        </form>
    </div>
