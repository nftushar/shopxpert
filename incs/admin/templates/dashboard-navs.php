...
<!-- Nav Start -->
<div class="smartshop-admin-main-nav">
    <ul class="smartshop-admin-main-nav-ul">
       
        <?php
            foreach( $navs as $key => $nav ){
                $classes = ['smartshop-admin-main-nav-li'];
                if( isset( $nav['class'] ) ){
                    $classes[] = $nav['class'];
                }
            ...
            ?>
                <li class="<?php echo esc_attr( $classes ); ?>">
                    <a href="#<?php echo esc_attr( $nav['id'] ); ?>" class="smartshop-admin-main-nav-btn">
