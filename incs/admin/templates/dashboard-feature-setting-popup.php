...
?>
<script type="text/template" id="tmpl-smartshopFeature">
    <div class="smartshop-Feature-setting-popup">
        <div id="smartshop-admin-pro-popup" class="smartshop-admin-popup open">
            <div class="smartshop-Feature-setting-popup-content smartshop-admin-popup-inner">
                ...
                <form class="smartshop-Feature-setting-data" id="smartshop-Feature-setting-form" action="#" method="post" data-section="{{data.section}}" data-fields="{{data.fileds}}">
                    {{{ data.content }}}
