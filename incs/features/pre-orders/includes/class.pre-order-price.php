...
class Shopxpert_Pre_Order_Price extends Shopxpert_Pre_Orders{
    ...
    public function pre_order_display_price( $price, $product ){
        ...
        $manage_price_lavel = $this->replace_placeholder( '{original_price}', '<span class="shopxpert-pre-order-original-price">'.$original_price_html.'</span><br/>', $manage_price_lavel );
        $manage_price_lavel = $this->replace_placeholder( '{preorder_price}', '<span class="shopxpert-pre-order-price">'.$price.'</span>', $manage_price_lavel );

        if( is_admin() || empty( $manage_price_lavel ) ){
            return $price;
        }else{
            return '<span class="shopxpert-pre-order-price-area">'.$manage_price_lavel.'</span>';
        }
