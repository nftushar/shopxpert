...
$banner_image 	= !empty( $settings['bannerImage']['id'] ) ? wp_get_attachment_image( $settings['bannerImage']['id'], 'full' ) : '<img src="'.esc_url($default_img_url).'" alt="'.esc_attr__("Banner Default image",'shopxpert').'" />';
		...
		<div class="banner-content">
			<?php
				...
				if( !empty( $settings['buttonText'] ) ){
					echo '<a href="'.esc_url( $banner_url ).'">'.esc_html__( $settings['buttonText'],'shopxpert' ).'</a>';
				}
			?>
		</div>
