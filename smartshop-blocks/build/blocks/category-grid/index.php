                    ...
                    <?php if( '1' === $layout ): ?>
                        <div class="ht-category-wrap">
                            ...
                            <div class="ht-category-content">
                                <h3><a href="<?php echo esc_url( $prod_cat['link'] ); ?>"><?php echo esc_html__( $prod_cat['name'], 'shopxpert' ); ?></a></h3>
                                <?php 
                                    if( $settings['showCount'] === true ){
                                        echo '<span>'.esc_html__( $prod_cat['count'], 'shopxpert' ).'</span>';
                                    }
                                ?>
                            </div>
                        </div>
                    ...
                    <?php elseif( '4' === $layout ):?>
                        <div class="ht-category-wrap">
                            ...
                            <div class="ht-category-content-4">
                                <h3>
                                    <a href="<?php echo esc_url( $prod_cat['link'] ); ?>"><?php echo esc_html__( $prod_cat['name'], 'shopxpert' ); ?></a>
                                    <?php 
                                        if( $settings['showCount'] === true ){
                                            echo '<span>('.esc_html__( $prod_cat['count'], 'shopxpert' ).')</span>';
                                        }
