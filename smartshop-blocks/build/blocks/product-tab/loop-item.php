                ...
                <div class="product_information_area">
                    ...
                    <?php
                        ...
                        if($attributes):
                            ...
                            <ul>
                                <?php
                                    echo '<li class="attribute_label">'.wc_attribute_label( $attribute->get_name() ).esc_html__(':','shopxpert').'</li>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
