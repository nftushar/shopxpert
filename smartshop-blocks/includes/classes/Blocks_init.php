...
class Blocks_init {
    ...
    public function prepare_block_data( $block ){
        ...
        if ( isset( $block['location'] ) ) {
            ...
            $block_dir = ( isset($block['is_pro']) && $block['is_pro'] == true && defined( "SHOPXPERT_ADDONS_PL_PATH_PRO" ) ) ? SHOPXPERT_ADDONS_PL_PATH_PRO . 'blocks/' : SHOPXPERT_BLOCK_PATH . '/build/blocks/';
        }
